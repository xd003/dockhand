...
// =============================================================================
// STACK-LEVEL AUTO-SYNC & WEBHOOK QUERY FUNCTIONS (stack mode)
// =============================================================================
...
const _scheduleTypeExhaustive: Exclude<ScheduleType, (typeof ALL_SCHEDULE_TYPES)[number]> extends never
	? Exclude<(typeof ALL_SCHEDULE_TYPES)[number], ScheduleType> extends never ? true : never
	: never = true;
