 ...
 * URL is attacker-influenced, or a hung-clone cap) pass `timeoutMs`
 * explicitly.
 */
 ...
 */
export function cleanGitError(stderr: string, ctx?: { authType?: string | null; url?: string | null }): string {
 ...
 * F9). Rows missing a model (should not happen post-0015 backfill) fall back
 * to the stack engine.
 */
